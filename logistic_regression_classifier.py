...
This module implements a multi-class logistic regression classifier using
stochastic gradient descent for training on the MNIST handwritten digits dataset.
"""
...
if __name__ == "__main__":
    ...
    print("LogisticRegressionClassifier implementation")
    print("To use with MNIST, run the training script: python mnist_train.py")
